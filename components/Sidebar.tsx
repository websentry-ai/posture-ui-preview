...
const sections: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/fleet/users', label: 'Users', icon: Users, soon: true },
      { href: '/fleet/tools', label: 'AI Tools', icon: Wrench, soon: true },
  ...
  },
  {
    title: 'Inventory',
    items: [
      { href: '/inventory/mcp', label: 'MCP Servers', icon: Package, soon: true },
      { href: '/inventory/extensions', label: 'Extensions', icon: Package, soon: true },
      { href: '/inventory/hooks', label: 'Hooks', icon: Package, soon: true },
      { href: '/inventory/agents', label: 'Agents & Binaries', icon: Server, soon: true },
    ],
  },
  {
    title: 'Evidence',
    items: [
      { href: '/drift', label: 'Drift & Baselines', icon: GitBranch, soon: true },
      { href: '/timeline', label: 'Timeline', icon: Clock, soon: true },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/rules', label: 'Detection Rules', icon: SlidersHorizontal, soon: true },
      { href: '/admin/suppressions', label: 'Suppressions', icon: EyeOff, soon: true },
      { href: '/admin/policies', label: 'Policies (MDM)', icon: ShieldCheck },
      { href: '/admin/integrations', label: 'Integrations', icon: Plug, soon: true },
      { href: '/admin/setup', label: 'Setup', icon: Cog, soon: true },
    ],
  },
];
